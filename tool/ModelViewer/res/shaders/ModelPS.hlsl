...
float4 main(const VSOutput input) : SV_TARGET0
{
    ...
    //    {
    //        output.r = dot(float3(1.0f, 0.0f, 0.0f), ToSRGB(HueToRGB(input.BoneIndices.x * 1.1)));
    //        output.g = dot(float3(0.0f, 1.0f, 0.0f), ToSRGB(HueToRGB(input.BoneIndices.y * 1.1)));
    //        output.b = dot(float3(0.0f, 0.0f, 1.0f), ToSRGB(HueToRGB(input.BoneIndices.z * 1.1)));
    //        output.a = dot(float3(1.0f, 1.0f, 1.0f), ToSRGB(HueToRGB(input.BoneIndices.w * 1.1)));
    //    }
    //    break;
