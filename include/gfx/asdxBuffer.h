...
public:
    ...
    //! @retval false   初期化に失敗.
    //-------------------------------------------------------------------------
    bool Init(uint64_t size, D3D12_RESOURCE_STATES state, bool dynamic = false);
    ...
    //! @retval false   初期化に失敗.
    //-------------------------------------------------------------------------
    bool Init(ID3D12GraphicsCommandList* pCmdList, uint64_t size, const void* pInitData, bool dynamic = false);
