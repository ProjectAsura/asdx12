...
public:
    ...
    //! @retval false   生成に失敗.
    //-------------------------------------------------------------------------
    static bool Create(std::vector<uint8_t>&&, Model** ppModel);
    ...
    //! @return     マテリアルを返却します.
    //-------------------------------------------------------------------------
    uintptr_t GetMaterial(uint32_t index) const;
    ...
    //-------------------------------------------------------------------------
    void SetMaterial(uint32_t index, uintptr_t pMaterial);
...
private:
    ...
    ModelBinary                 m_ModelBinary;                  //!< モデルバイナリです.
    std::vector<uintptr_t>      m_MaterialSlots;                //!< マテリアルスロットです.
