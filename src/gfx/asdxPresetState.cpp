...
const D3D12_DEPTH_STENCIL_DESC Preset::ReverseDepthReadWrite = {
    TRUE,
    D3D12_DEPTH_WRITE_MASK_ALL,
...
const D3D12_DEPTH_STENCIL_DESC Preset::ReverseDepthReadOnly = {
    TRUE,
    D3D12_DEPTH_WRITE_MASK_ZERO,
    D3D12_COMPARISON_FUNC_GREATER_EQUAL,
    FALSE,
...
const D3D12_DEPTH_STENCIL_DESC Preset::ReverseDepthWriteOnly = {
    FALSE,
    D3D12_DEPTH_WRITE_MASK_ALL,
    D3D12_COMPARISON_FUNC_GREATER_EQUAL,
    FALSE,
...
const D3D12_RENDER_TARGET_BLEND_DESC Preset::RTB_Min = {
    TRUE,
    FALSE,
    D3D12_BLEND_ONE,
    D3D12_BLEND_ONE,
...
const D3D12_RENDER_TARGET_BLEND_DESC Preset::RTB_Max = {
    TRUE,
    FALSE,
    D3D12_BLEND_ONE,
    D3D12_BLEND_ONE,
...
const D3D12_BLEND_DESC Preset::BlendMin = {
    FALSE,
    FALSE,
    { RTB_Min, RTB_Min, RTB_Min, RTB_Min, RTB_Min, RTB_Min, RTB_Min, RTB_Min }
};
const D3D12_BLEND_DESC Preset::BlendMax = {
    FALSE,
    FALSE,
    { RTB_Max, RTB_Max, RTB_Max, RTB_Max, RTB_Max, RTB_Max, RTB_Max, RTB_Max }
};
...
const D3D12_STATIC_SAMPLER_DESC Preset::StaticSamplers[11] = {
    ...
    DEF_STATIC_SAMPLER(D3D12_FILTER_COMPARISON_MIN_MAG_MIP_LINEAR, D3D12_TEXTURE_ADDRESS_MODE_BORDER, 0, D3D12_COMPARISON_FUNC_LESS_EQUAL,    D3D12_STATIC_BORDER_COLOR_OPAQUE_WHITE,  9),
    DEF_STATIC_SAMPLER(D3D12_FILTER_COMPARISON_MIN_MAG_MIP_LINEAR, D3D12_TEXTURE_ADDRESS_MODE_BORDER, 0, D3D12_COMPARISON_FUNC_GREATER_EQUAL, D3D12_STATIC_BORDER_COLOR_OPAQUE_WHITE, 10),
};
