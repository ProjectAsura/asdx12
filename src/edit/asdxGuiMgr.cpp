...
)
{
...

    {
        ...
        res.Pixels              = ArrayView(pPixels, subRes.SlicePitch);
...

    {
        ...
        style.Colors[ImGuiCol_Border]                 = ImVec4(0.43f, 0.50f, 0.43f, 0.50f);
        ...
        style.Colors[ImGuiCol_PlotHistogram]          = ImVec4(0.90f, 0.00f, 0.70f, 1.00f);
        style.Colors[ImGuiCol_PlotHistogramHovered]   = ImVec4(1.00f, 0.00f, 0.60f, 1.00f);
        style.Colors[ImGuiCol_TableHeaderBg]          = ImVec4(0.19f, 0.20f, 0.19f, 1.00f);
        style.Colors[ImGuiCol_TableBorderStrong]      = ImVec4(0.31f, 0.35f, 0.31f, 1.00f);   // Prefer using Alpha=1.0 here
        ...
        style.Colors[ImGuiCol_TreeLines]              = style.Colors[ImGuiCol_Border];
        style.Colors[ImGuiCol_DragDropTarget]         = ImVec4(1.00f, 0.00f, 1.00f, 0.90f);
